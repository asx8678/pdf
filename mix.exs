defmodule Quire.MixProject do
  ...
  defp aliases do
    [
      ...
      "assets.setup": ["tailwind.install --if-missing", "esbuild.install --if-missing", "cmd bash assets/vendor/pdfjs-copy.sh"],
      "assets.build": ["compile", "tailwind quire", "esbuild quire", "esbuild pdf_viewer"],
      "assets.deploy": [
