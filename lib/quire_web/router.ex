defmodule QuireWeb.Router do
  use QuireWeb, :router

  import QuireWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {QuireWeb.Layouts, :root}
  ...
  if Application.compile_env(:quire, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: QuireWeb.Telemetry
